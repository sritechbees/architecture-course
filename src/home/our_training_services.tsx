...
function OurTrainingServices() {
  return (
    <div className="p-6 bg-gray-100 text-gray-900">
      <h2 className="text-3xl font-semibold text-center mb-6">Our Training Services</h2>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white p-4 shadow-md rounded-lg">
          <h3 className="text-xl font-semibold mb-2">Fundamentals of Architecture</h3>
          <p>
      ...
      <div className="mt-6 flex flex-col items-center justify-center bg-blue-50 p-6 rounded-lg shadow-md">
        <p className="text-xl font-bold text-blue-900">Why Choose Our Training?</p>
